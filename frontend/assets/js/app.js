...
function renderProfileCard() {
    ...
    const roleEl = document.getElementById("dashboard-profile-role");
    ...
    if (avatarEl) {
        avatarEl.src = currentUser.avatar_url || "assets/img/default-user.png";
    }
}
...
$(function () {
    ...
    // Edit Profile button on the dashboard card
